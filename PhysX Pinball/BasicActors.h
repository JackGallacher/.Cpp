...
namespace PhysicsEngine
{
	...
	public:
		...
		PxTriangleMesh* CookMesh(const PxTriangleMeshDesc& mesh_desc)
		{
			...
			if(!GetCooking()->cookTriangleMesh(mesh_desc, stream))//sometimes throws a break error here, usually works after a few tries, something to do with the cooking. I have no idea how to fix this.
